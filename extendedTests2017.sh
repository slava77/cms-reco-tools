#!/bin/bash
echo "started QCD wf 10043.0"
runTheMatrix.py -l 10043.0 -w upgrade --useInput all --command="-n 600 --customise Validation/Performance/TimeMemoryInfo.py" >& run10043.0_600.log &
...
echo "started QCD 3TeV wf 10030.0"
runTheMatrix.py -l 10030.0 -w upgrade --useInput all --command="-n 400 --customise Validation/Performance/TimeMemoryInfo.py" >& run10030.0_400.log &
if [ "x${1}" == "xALL" ]; then 
